...
| Red Hat 7          | `yum install -y mariadb-server mariadb`                                 |
...
| Red Hat 7          | add `character-set-server=utf8` line to `[server]` section of `/etc/my.cnf.d/server.cnf` file and restart mysqld   |
...
| Red Hat 7          | `subscription-manager repos --enable=rhel-server-rhscl-7-rpms`
                       `yum install httpd24 rh-php56 rh-php56-php-mysqlnd rh-php56-php-pdo rh-php56-php-gd rh-php56-php-snmp rh-php56-php-mbstring rh-php56-php-bcmath rh-php56-php-ldap rh-php56-php`
...
| --------------- | ----------------------- | -------------------------------- |
| Fedora 23-32    | `apache:apache`         | `/var/lib/mysql/mysql.sock`      |
