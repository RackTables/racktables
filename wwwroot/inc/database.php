...
function addIPLogEntry ($ip_bin, $message)
{
    ...
    {
    case 4:
        return addIPv4LogEntry ($ip_bin, $message);
    case 16:
        return addIPv6LogEntry ($ip_bin, $message);
    default:
...
function fetchIPLogEntry ($ip_bin)
{
    ...
    {
    case 4:
        return fetchIPv4LogEntry ($ip_bin);
    case 16:
        return fetchIPv6LogEntry ($ip_bin);
    default:
        throw new InvalidArgException ('ip_bin', $ip_bin, "Invalid binary IP");
    }
}
...
function getIPAddressNetworkId ($ip_bin, $masklen = NULL)
{
    ...
    {
    case 4:
        return getIPv4AddressNetworkId ($ip_bin, isset ($masklen) ? $masklen : 32);
    case 16:
        return getIPv6AddressNetworkId ($ip_bin, isset ($masklen) ? $masklen : 128);
    default:
        throw new InvalidArgException ('ip_bin', $ip_bin, "Invalid binary IP");
    }
}
...
function updateIPBond ($ip_bin, $object_id=0, $name='', $type='')
{
    ...
    {
    case 4:
        return updateIPv4Bond ($ip_bin, $object_id, $name, $type);
    case 16:
        return updateIPv6Bond ($ip_bin, $object_id, $name, $type);
    default:
        throw new InvalidArgException ('ip_bin', $ip_bin, "Invalid binary IP");
    }
}
