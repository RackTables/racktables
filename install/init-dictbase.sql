...
INSERT INTO `Config` (varname, varvalue, vartype, emptyok, is_hidden, description) VALUES ('IPV4_TREE_COUNT_USAGE','yes','string','no','no','Count address usage in IPv4 tree');
